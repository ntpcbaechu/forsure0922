...
<body>
  ...
  <div class="filter-card">
    ...
    <div class="filter-row">
      <span class="filter-label">3. 狀態篩選：</span>
  ...
  <script type="module">
    ...
    function renderView() {
      ...
      if (list.length === 0) {
        container.innerHTML = '<p style="color:#909399; font-size:14px; grid-column: 1 / -1;">目前尚無已結束歸檔的進度紀錄。</p>';
        notifyHeight();
        return;
      }
      ...
      container.innerHTML = htmlContent || '<p style="color:#909399; font-size:14px; grid-column: 1 / -1;">目前尚無已結束歸檔的進度紀錄。</p>';
      notifyHeight();
    }
...
paths = [
    'index/index_archive_progress.html',
    'index/archive/index_archive_progress.html'
]
